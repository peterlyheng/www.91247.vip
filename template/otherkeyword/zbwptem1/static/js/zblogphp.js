(function () {
  var t = "system-default",
    ...
    o = function (o, r) {
      if ("undefined" == typeof jQuery && void 0 === r)
        throw new Error("No jQuery!");
      (this.$ = r || window.jQuery),
        Object.keys ||
      ...
      return (
        i(this),
        (o = o || {}),
        (o.cookiepath = o.cookiepath || "/"),
        (o.bloghost = o.bloghost || location.origin),
        (o.ajaxurl = o.ajaxurl || location.origin),
        (o.commentmaxlength = o.commentmaxlength || 1e3),
        (o.lang = o.lang || {}),
        (o.comment = o.comment || {}),
        (o.comment.inputs = o.comment.inputs || {}),
        (o.comment.useDefaultEvents = o.comment.useDefaultEvents || !1),
        (this.eachOnCommentInputs = function (t) {
            ...
            e.validator ||
              (e.validator = function (t, n) {
                for (t = t || e.getter(); ; ) {
                  ...
                  if (
                    e.validateRule &&
                    ((e.validateRule.lastIndex = 0), !e.validateRule.test(t))
                  )
                    break;
                  return n(null);
                }
                var o = new Error(
                  e.validateFailedMessage ||
                    s.options.lang.error[e.validateFailedErrorCode]
                );
        ...
        this.plugin.on("userinfo.output", "system", function () {
          s.eachOnCommentInputs(function (t, e) {
            e.saveLocally &&
              ((s.userinfo[t] = s.cookie.get("zbp_userinfo_" + t)),
              s.userinfo[t] && e.setter(s.userinfo[t]));
          });
        }),
        ...
        this.plugin.on("userinfo.save", "system", function () {
          s.eachOnCommentInputs(function (t, e) {
            e.saveLocally &&
              ((s.userinfo[t] = e.getter()),
              s.cookie.set("zbp_userinfo_" + t, s.userinfo[t]));
          });
        }),
            ...
            o = function (o) {
              if (!n) {
                if (o)
                  return (
                    (n = !0),
                    void s.plugin.emit("comment.post.validate.error", o, t)
                  );
        ...
        this.plugin.on("comment.post.start", "system", function (t) {
          s.eachOnCommentInputs(function (e, n) {
            ...
            (t.commentKey = new Date().getTime() + "" + Math.random()),
            s.plugin.emit("comment.post.validate", t);
        }),
        this.plugin.on(
          "comment.post.validate.error",
          "system",
          function (t, e) {
          ...
          s.$.post(t.action, t)
            .done(function (e, n, o) {
              ...
              if (i.err && i.err.code > 0) {
                ...
                (r.code = i.err.code),
                  s.plugin.emit("comment.post.error", r, t, i, n, o);
        ...
        this.plugin.on(
          ...
          function (t, e, n, o, i) {
            s.plugin.emit(
              "comment.posterror",
              { jqXHR: i, msg: t.message, code: t.code },
              e
            ),
              s.plugin.emit("comment.post.done", t, e, n, o, i);
          }
        ),
        this.options.comment.useDefaultEvents &&
          (this.plugin.on("comment.reply.start", t, function (t) {
            this.$("#inpRevID").val(t),
              this.$("#cancel-reply")
                .show()
                .bind("click", function () {
                  return (
                    s.plugin.emit("comment.reply.cancel"),
                    s.$("#inpRevID").val(0),
                    s.$(this).hide(),
          ...
          this.plugin.on("comment.post.done", t, function (t) {
            ...
            e.removeClass("loading").removeAttr("disabled"),
              e.data("orig") && e.val(e.data("orig"));
          }),
          this.plugin.on("comment.post.success", t, function (t, e, n, o) {
            "0" === t.replyid.toString()
              ? this.$(e.data.html).insertAfter("#AjaxCommentBegin")
              : this.$(e.data.html).insertAfter("#AjaxComment" + t.replyid),
              (location.hash = "#cmt" + e.data.ID),
              this.$("#txaArticle").val(""),
  ...
  var i = function (o) {
    (o.utils = {}),
      (o.utils.getFromIndex = function (t, e) {
    ...
    (i.prototype.checkIsInterfaceDeprecated = function (t) {
      return (
        ...
        (console.warn(
          "Interface '" +
            t +
            "' is deprecated in ZBP 1.6, please update your plugin or theme!"
        ),
        !0)
      );
    }),
      (i.prototype.bind =
        i.prototype.on =
        i.prototype.addListener =
          function (t, e, i) {
            return (
              this.checkIsInterfaceDeprecated(t) && n[t] && (t = n[t]),
              void 0 === o._plugins[t] && (o._plugins[t] = {}),
              (o._plugins[t][e] = i),
              o
            );
          }),
      (i.prototype.unbind = i.prototype.removeListener =
        function (e, i) {
          return (
            i || (i = ""),
            this.checkIsInterfaceDeprecated(e) &&
              "system" === i &&
              ((i = t), n[e] && (e = n[e])),
            "" === i
              ? (o._plugins[e] = {})
              : o._plugins[e] &&
                ((o._plugins[e][i] = null), delete o._plugins[e][i]),
            o
          );
        }),
    ...
    (r.prototype.get = function (t) {
      ...
      (r.prototype.set = function (t, e, n) {
        var i = new Date();
        return (
          n && i.setTime(i.getTime() + parseInt(24 * n * 60 * 60 * 1e3)),
          (document.cookie =
            t +
            "=" +
            escape(e) +
    ...
    (s.prototype.output = function () {
      ...
      (s.prototype.saveFromHtml = s.prototype.readFromHtml =
        function () {
